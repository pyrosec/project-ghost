...
export class AriTranscriber {
  public audioServer: any;
  public opts: any;
  public ariController: any;
  public speechProvider: GoogleSpeechProvider;
  ...
  async transcriber() {
    ...
    console.log(
      `Creating ARI Controller to Asterisk instance ${this.opts.ariServerUrl}`,
    );
    this.ariController = new AriController(this.opts);
    ...
    this.audioServer = new RtpUdpServerSocket(
    ...
    this.speechProvider = new GoogleSpeechProvider(
      config,
      this.audioServer,
      (text, isFinal) => {
