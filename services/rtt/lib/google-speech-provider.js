...
class GoogleSpeechProvider {
    ...
    startStream() {
        ...
        this.cb = (stream) => {
            ...
            if (this.transcriptCallback && results[0] && results[0].alternatives[0]) {
                this.transcriptCallback(results[0].alternatives[0].transcript, results[0].isFinal);
            }
    ...
    speechCallback(stream) {
        ...
        if (stream.results[0].isFinal) {
            ...
            process.stdout.write(chalk_1.default.green(`${stdoutText}\n`));
            ...
            process.stdout.write(chalk_1.default.red(`${stdoutText}`));
            this.lastTranscriptWasFinal = false;
        }
    ...
    restartStream() {
        ...
        process.stdout.write(chalk_1.default.yellow(`${this.streamingLimit * this.restartCounter}: RESTARTING REQUEST\n`));
        this.newStream = true;
        this.startStream();
    }
}
exports.GoogleSpeechProvider = GoogleSpeechProvider;
//# sourceMappingURL=google-speech-provider.js.map